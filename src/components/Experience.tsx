...
const EXPERIENCES: Experience[] = [
  {
    ...
    description: [
      ...
      "Build stateful banking journeys over the WhatsApp Business Cloud API, integrating banking and mobile money services through a standardised backend approach designed to streamline the onboarding of additional partners.",
      "Build resilient money-movement workflows with safeguards against retries, duplicate operations and inconsistent transaction states, while supporting reconciliation with external financial systems.",
      "Run the platform on AWS, with CloudWatch and Sentry for observability and end-to-end traceability, plus internal Next.js back-offices for the ops and support teams.",
    ],
    descriptionFr: [
      ...
      "Conception de parcours bancaires à état sur la WhatsApp Business Cloud API, avec intégration des services bancaires et mobile money via une approche backend standardisée pensée pour faciliter l'onboarding de nouveaux partenaires.",
      "Développement de workflows de mouvement de fonds résilients, avec garde-fous contre les retries, les opérations dupliquées et les états de transaction incohérents, et prise en charge de la réconciliation avec des systèmes financiers externes.",
      "Exploitation de la plateforme sur AWS, avec CloudWatch et Sentry pour l'observabilité et la traçabilité de bout en bout, et back-offices internes en Next.js pour les équipes ops et support.",
    ],
